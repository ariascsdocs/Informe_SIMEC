...
def main():
    ...
    print("\n🚀 Ejecutando primer push inmediatamente...")
    auto_push_changes()
    print("✅ Primer push completado.")
    
    # Fase de Programación
    print("\n⏳ Programando la ejecución de 'auto_push_changes' cada **25 minutos**.")
    schedule.every(25).minutes.do(auto_push_changes)
    
    print("✅ ¡El script está cargado en la memoria y se ejecutará automáticamente cada 25 minutos!")
